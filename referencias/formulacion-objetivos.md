# Formulación de objetivos de aprendizaje — Documento de referencia
...
### 1.1 El objetivo debe ser observable y medible

Un objetivo bien formulado describe algo que el profesor puede **ver u oír** que el alumno hace. Si no se puede observar, no es un objetivo: es una intención.

| Tipo | Ejemplo | ¿Se puede observar? |
|------|---------|---------------------|
| Intención (NO usar) | "Dominar el vocabulario de familia" | No. ¿Cómo sabe el profesor que lo "domina"? |
| Intención (NO usar) | "Conocer las relaciones de parentesco" | No. "Conocer" es interno, no observable. |
| Intención (NO usar) | "Entender la conjugación del presente" | No. "Entender" es un proceso mental invisible. |
| Objetivo (SÍ usar) | "Nombrar los miembros de una familia señalándolos en un árbol genealógico" | Sí. El profesor ve al alumno señalar y decir el nombre. |
| Objetivo (SÍ usar) | "Describir su propia familia usando frases sencillas con al menos 4 miembros" | Sí. El profesor lee/escucha la producción y verifica. |
| Objetivo (SÍ usar) | "Conjugar los verbos regulares en presente completando una tabla de 3 conjugaciones" | Sí. El profesor revisa la tabla completada. |

### 1.2 El objetivo debe ser coherente con el nivel A1.1

El MCER define A1 así (CVC Cervantes, Cap. 3):
...
|------------|-----------|--------------------------|
| **Verbo observable** | Acción que el alumno ejecuta y el profesor puede ver/oír | Nombrar |
...
Verbos: **identificar, reconocer, nombrar, repetir, listar, señalar, localizar, etiquetar, emparejar**

Uso en lenguas: el alumno recupera de memoria una palabra, una forma, un significado.

Ejemplos para secciones del libro:
- Vocabulario: "Nombrar los miembros de una familia"
- Gramática: "Identificar las terminaciones del presente regular (-o, -as, -a, -amos, -áis, -an)"
- Comunicación: "Repetir los exponentes para presentar a alguien"

### Nivel 2 — COMPRENDER (dar sentido, interpretar)

Verbos: **asociar, clasificar, comparar, distinguir, explicar (en L1), interpretar, resumir, deducir, parafrasear**

Uso en lenguas: el alumno entiende el significado, conecta forma y sentido, agrupa por categorías.

Ejemplos para secciones del libro:
- Vocabulario: "Asociar cada término de parentesco con su posición en un árbol genealógico"
- Gramática: "Clasificar verbos en las tres conjugaciones (-ar, -er, -ir)"
- Comunicación: "Distinguir entre presentación formal e informal"
- Cultura: "Comparar las familias de Javier y Leonora identificando 3 diferencias"

### Nivel 3 — APLICAR (usar en contexto)

Verbos: **usar, producir, describir, completar, construir, resolver, demostrar, formular, escribir, presentar**

Uso en lenguas: el alumno usa la lengua para comunicar algo propio, transfiere lo aprendido a un contexto nuevo.

Ejemplos para secciones del libro:
- Vocabulario: "Describir su propia familia usando frases sencillas"
- Gramática: "Completar frases con la forma correcta del presente regular"
- Comunicación: "Presentar a un compañero de clase al grupo usando los exponentes aprendidos"
- Destrezas: "Escribir un correo de 40-60 palabras describiendo a su familia"
...
| **Comprender** (como objetivo) | Proceso interno; solo es observable si se pide una acción que lo demuestre | Resumir, parafrasear, explicar (en L1) |
| **Saber** | Proceso interno, no observable | Demostrar, producir, resolver |
...
| **Interiorizar** | No observable | Usar de forma espontánea (si es A2+) |
| **Asimilar** | No observable | Aplicar, transferir |
