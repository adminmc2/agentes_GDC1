...
|------------|------------|
| **Vocabulario** | Ropa |
| **Gramática** | Pretérito indefinido de *ir* y *estar*, Marcadores temporales del pasado: *ayer, por la mañana, el año pasado, hace una...*, Interrogativos: *dónde, qué, cuándo, quién, con quién* |
| **Comunicación** | Preguntar por acciones en el pasado: *¿Dónde estuviste? / ¿Con quién fuiste?* |
| **Pronunciación y ortografía** | Acentuación: agudas, llanas, esdrújulas |
| **Para aprender** | Análisis de errores |
| **Destrezas** | Segovia: Patrimonio de la Humanidad |
| **Cultura** | Trajes tradicionales de España |
...
| | Contenidos |
|---|---|
| **Unidad anterior (U08)** | *Doler*, cuantificadores, cuerpo humano, descripciones |
| **Unidad posterior** | Fin del curso / Nuevo Compañeros 2 |
...
|---------|-------------------|---------|-----------------|
| *pendiente — necesito datos/U09-inventario.json* |
