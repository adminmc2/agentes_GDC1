...
Objetivo
Construir frases sencillas en presente singular para hablar de uno mismo.

Imprimir ficha 1.2—insignia: **¡YO SOY YO!**

Insignia y obtención
Comente a los estudiantes que al terminar la sección recibirán la insignia **¡YO SOY YO!** Para obtenerla deberán construir frases con ser, llamarse y tener en presente singular, aplicar la concordancia de género en sustantivos y adjetivos, y formular preguntas con los interrogativos básicos.

### Ejercicios 1-3

Objetivo
Conjugar los verbos ser, llamarse y tener en presente singular.
...
Antes del **ejercicio 4**, dirija la atención a los tres cuadros pequeños de la **página 14**: artículos determinados, masculino y femenino y nacionalidad. Lea con ellos los ejemplos como pares mínimos: *mexicano · mexicana*, *español · española*, *estudiante · estudiante*.

Lance al grupo cuatro preguntas breves, una a una, recogiendo dos o tres respuestas antes de pasar a la siguiente:
...
4. *¿Hay algo que se repite?* (en -o cambia a -a; en consonante, suele añadir -a; estudiante/cantante no cambian).
...
Para el **ejercicio 6**, escriben doce frases con el verbo *ser* partiendo de pares sujeto + complemento dados (yo / profesora, Elaine / brasileña…). Añaden el verbo y, en su caso, el artículo. Insista en que el adjetivo concuerda en género (y en número si aparece plural) con el sujeto. Corrigen en parejas.

Antes del **ejercicio 7**, prepare el descubrimiento de los colores en la pizarra. Escriba dos parejas de frases con objetos conocidos: *La mochila es roja / El libro es rojo* y *La silla es azul / El bolígrafo es azul*. Léalas con la clase y subraye las terminaciones de los adjetivos. Lance dos preguntas: *¿Qué ha cambiado entre roja y rojo? ¿Y entre azul y azul?* Verbalizan en parejas. Recoja respuestas y guíelos a la pauta: los colores acabados en -o cambian a -a con palabras femeninas; los acabados en consonante no cambian (azul, marrón); como excepción, algunos acabados en vocal tampoco cambian (verde, rosa, naranja).

Escriba en la pizarra los ocho colores del libro (*rojo, blanco, negro, amarillo, azul, marrón, verde, rosa*) y dos columnas: **CAMBIA** y **NO CAMBIA**. Pida a la clase clasificar los ocho en plenaria, uno a uno, con justificación breve. Cuando estén colocados, desdoble los cuatro de la columna que cambia en sus pares: *rojo/roja, blanco/blanca, negro/negra, amarillo/amarilla*. Cierre con el recuadro de los colores de la **página 15**.
...
Cierre con una pregunta abierta: *¿qué patrón habéis notado entre el masculino y el femenino?* Recoja dos o tres formulaciones con sus palabras (terminaciones -o/-a, añadir -a en consonante, invariables como estudiante/cantante, colores que no cambian). Confirme conectando con los tres cuadros de la **página 14** y el cuadro de colores de la **página 15**.

### Ejercicios 8-10

Objetivo
Formular preguntas con los interrogativos básicos.
...
En el **ejercicio 10** eligen dos o tres preguntas de los ejercicios anteriores y se las hacen al profesor. La consigna del libro: *haz a tu profesor las preguntas anteriores y practica con otras palabras*. Adapte: si la pregunta es *¿Cómo se dice "hello" en español?*, el alumno puede sustituir *hello* por una palabra real que quiera saber. El docente responde. Tres o cuatro preguntas por estudiante bastan. Cierre cuando la mayoría haya hecho al menos una pregunta.
