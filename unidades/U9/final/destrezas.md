...
Objetivo
Contar un viaje propio en pasado, al teléfono y por escrito, a partir de los viajes leídos y escuchados.

Imprimir ficha 9.4—insignia: **¡¿Y TÚ DÓNDE FUISTE?!**

Insignia y obtención
Comente a la clase que al terminar la sección recibirán la insignia **¡¿Y TÚ DÓNDE FUISTE?!** Para obtenerla deberán corregir las afirmaciones falsas del folleto de Segovia, ordenar la visita de María, reconocer dos ciudades romanas por las claves de sus textos, contar al teléfono el viaje de otra persona del aula y escribir su propio blog del viaje.

### Ejercicios 1-2

Objetivo
Identificar datos concretos en un folleto turístico.
...
| 📽 PÍLDORA FORMATIVA 9.3 · *Las tres claves del detective* |
|---|
...
Objetivo
Presentar un viaje en pasado, al teléfono y en el blog.
...
Lea con la clase el blog de Nuria del **ejercicio 6**, separando qué se mantiene —la estructura en partes, cada una abierta por su palabra-puente— y qué cambia con cada autor —los datos del viaje—.

Entregue la tarjeta *Dale forma al texto* y léala con la clase. La cara de la estructura entrega el texto en tres partes —abrir, contar en orden, cerrar— con los inicios ya escritos: se copian tal cual y los huecos se rellenan con los datos propios. La cara de las palabras-puente da las palabras de tiempo y de idea para variar los inicios.

Defina la tarea: cada estudiante escribe el blog de un viaje reciente con su familia, real o imaginario. Primero apunta en el cuaderno los datos —dónde, con quién, qué sitios, en qué orden— y después copia la estructura de la tarjeta rellenando los huecos, con la cara de las palabras-puente a la vista. Pase entre las mesas resolviendo dudas con el indefinido de *ir* y *estar*.

Revisión en pareja con dos focos: el indefinido de *ir* y *estar* en primera persona y las palabras-puente entre las partes; quien revisa devuelve el blog con dos o tres marcas, no más. Recoja dos o tres blogs leídos a la clase por quienes se ofrezcan y, tras cada lectura, cierre con la misma pregunta de la llamada: *¿Os hacéis una idea del viaje?*

ENTREGA DE INSIGNIA

Mencione que por corregir las afirmaciones falsas del folleto de Segovia, ordenar la visita de María, reconocer Mérida y Alcalá de Henares por las claves de sus textos, contar al teléfono el viaje de otra persona del aula y escribir su propio blog del viaje, reciben la insignia **¡¿Y TÚ DÓNDE FUISTE?!**
