# Rediseño de fase 2 — documento de trabajo

> **Estado:** EN CONSTRUCCIÓN. Se elimina cuando el rediseño se cierre y la decisión final viva en `CLAUDE.md`, `reglas-reciclaje.md` y PROCESO-MAESTRO.
>
