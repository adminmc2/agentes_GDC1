...
>
> **Última actualización:** 2026-05-15 (v10.134 — sincronización de P-decisiones tras retirada de "Nombres propios": U1 P4 + U2 P3 reescritas).
...
| Bloque | Estado |
|---|---|
| Fase 1 — Extracción de inventario | ✅ U0-U9 extraídas e integradas con el contrato pre-rediseño. **Canon semántico activado** en rollout R1 (v10.108). Rediseño operativo cerrado en v10.115-117 (reglas IA-first + convenciones reseteadas + 4 registries canónicos poblados — léxico, verbal, gramatical, pron-orto). **6 archivos operativos** + 4 registries + 4 PCIC A1 en `fases/1-extraccion-inventario/`. Deuda transitoria viva: alineación de `scripts/validar_inventario.py` con el schema post-rediseño (§A.1 del schema). |
...
**Resultado vivo:** U0/U1/U3 validan 0/0 con el contrato post-refactor (taxonomía 20 + destreza/enfoque); **6 archivos operativos** en `fases/1-extraccion-inventario/` (CLAUDE, prompt, schema, reglas, glosario, convenciones-y-casos — el glosario se añadió en v10.111); validador y schema **alineados hasta v10.62 (cross-check A4.5.5); post-rediseño v10.115-117 la alineación queda transitoriamente declarada como deuda** en el Apéndice §A.1 del schema (validación manual sustitutiva hasta retirada del apéndice); refs históricas archivadas en `docs/historico/refactor-prompt-fase1/`.
