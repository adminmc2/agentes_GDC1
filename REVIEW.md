...
| **A4.2** | Migrar contenido fila por fila aplicando split por capa + verificación de anclas | 🔄 (a) ✅ schema · (b) ✅ reglas-operativas migrado + recuperación de contenido perdido en A4.2a · (c) 📋 convenciones-y-casos |
